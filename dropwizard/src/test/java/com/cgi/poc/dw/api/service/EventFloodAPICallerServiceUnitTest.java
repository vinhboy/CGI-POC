...
public class EventFloodAPICallerServiceUnitTest {
  ...
  public void newEventWithNoAffectedUsers() throws IOException {
    ...
    EventFlood eventFromDB = mock(EventFlood.class);
    when(eventDAO.selectForUpdate(any(EventFlood.class))).thenReturn(eventFromDB);
  ...
  public void changedEventWithNoAffectedUsers() throws IOException {
    ...
    EventFlood retEvent = mock(EventFlood.class);
    when(eventDAO.save(any(EventFlood.class))).thenReturn(retEvent);
  ...
  public void logsTheErrorWhenParsingUnexpectedJson() throws IOException {
    ...
    assertThat(loggingEvent.getFormattedMessage().toLowerCase(),
        containsString("unable to parse the result for the flood event : error:"));
  }
